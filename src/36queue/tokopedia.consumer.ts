...
export class TokopediaConsumer {
        ...
        return new Promise<void>((resolve, reject) => {
          this.channel?.consume(queue, async (msg) => {
            ...
            try {
              ...
              this.writeMessageToLog(`t_msg_${this.consumerId}.log`, `${queue}_${msg.content.toString()}`);
              resolve();
            } catch (error) {
...
export async function runTokopediaConsumer(id: string) {
  const consumer = new TokopediaConsumer(id);
